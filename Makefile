# Makefile based on https://github.com/apmorton/teensy-template
...
# LIBRARYPATH = /Applications/Arduino.app/Contents/Java/hardware/teensy/avr/libraries
LIBRARYPATH = libraries

# path location for the arm-none-eabi compiler
COMPILERPATH = $(TOOLSPATH)/arm/bin

# path location for my libraries
# MYLIBRARYPATH = /Users/brandin/Documents/Arduino/libraries
...
# linker options
LDFLAGS = -Os -Wl,--gc-sections -mthumb -Wl,--defsym=__rtc_localtime=0
...
# compile our one and only source file!
INO_FILES := teensytap.ino

# include paths for libraries
L_INC := $(foreach lib,$(filter %/, $(wildcard $(LIBRARYPATH)/*/)), -I$(lib))
# L_INC := -I$(LIBRARYPATH)/Audio/utility
# L_INC += -I$(MYLIBRARYPATH)/SdFat/src
# L_INC += -I$(MYLIBRARYPATH)/SdFat/src/FatLib
# L_INC += -I$(MYLIBRARYPATH)/SdFat/src/SdSpiCard
